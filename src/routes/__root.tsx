  ...
  head: () => ({
    meta: [
      ...
      { title: "CRI BLO" },
      {
        name: "description",
        content:
          "Application terrain Orange pour techniciens — compte-rendu d'intervention Boucle Locale (CRI BLO).",
      },
      { name: "author", content: "Orange France" },
      { name: "theme-color", content: "#FF7900" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "CRI BLO" },
      { property: "og:title", content: "CRI BLO" },
